...
<div class="clearfix">
    ...
    <div class="r">
        ...
        <img src="<?php echo $spot['course_27']['url'] ?>" alt="" width="100%">
        <?php } ?>
        <?php 
            if ($current_lang == 'en') {
        ?>
            <a href="<?= !empty( $spot['course_26'] )? getUrlSite().'/'.$spot['course_26'].'?a=course' : 'javascript:;'  ?>" class="show_640 btn2 text_center">
